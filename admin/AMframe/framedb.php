...
class database {
    ...
    private $user ="lifeempowerment";
    private $password ="lifeempowerment";
    private $database = "lifeempowerment";
    private $dbh;
    private $error;
    private $stmt;
...
//======================================================================================	
	public function insertrec($que) {
		try {
		        $que = strip_tags($que,'<a><p><em><i><strong><h1><h2><h3><h4><h5><h6>');
...
//======================================================================================	
	public function singlerec($que) {
	 ...
	 public function get_all_1_col($query){
		try{
