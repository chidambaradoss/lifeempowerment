        ...
        <div id="container" class="cls-container">
            ...
            <div class="lock-wrapper">
                <div class="panel lock-box">
						...
						<input type="hidden" name="ctadby" value="1">
							...
							<?echo $Message;?>
                                <div class="text-left">
                                    ...
                                    <input id="signupInputEmail1" type="text"  name="username" placeholder="Enter Email ID" class="form-control" required />
                                </div>
                                <div class="text-left">
                                    <label for="signupInputPassword" class="text-muted">Password</label>
                                    <input id="signupInputPassword" type="password" name="pass" placeholder="Password" class="form-control lock-input" required />
                                </div>
					...
					<!--<div class="registration"> <a href="forgotpassword.php"> <span class="text-primary"> Forgot Password </span> </a> </div>-->
                </div>
