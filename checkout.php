							...
							<div class="col-md-4">
								<div class="your-order">
									...
									<table>
										...
										<tbody>
										<?php $pay=$db->singlerec("select title,price from course where id='$payid'"); ?>
											<tr>
											...
											<!--<tr>
												<td>How We'll Live on Mars  x 1</td>
												<td>$110.00</td>
											</tr>-->
										</tbody>
										<tfoot>
											...
											<tr class="order-total">
												<th>Total</th>
												<td><span class="amount"><?php echo $pay['price'];?></span></td>
											</tr>
										</tfoot>
									</table><br>
											...
											<!--<li class="payment_method_bacs">
												...
												<div class="radio">
													<input  id="payment_method_cheque" type="radio" class="input-radio" name="paypal" value="0" checked="checked"	 />
...
<script> 	
	...
	ErrorText= "";
	if ( ( checkform.paypal[0].checked == false ) && ( checkform.paypal[1].checked == false ) ) 
	{
		swal ("Oops...", "Please choose your Payment option","error" ); 
		return false;
	}
