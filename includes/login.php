...
if(isset($_REQUEST['dlogin'])){
	...
	if(empty($id)){
		...
		echo "<script>location.href='http://thavasu.com/demo/online_education/userprofile.php';</script>";
		header("Location: http://thavasu.com/demo/online_education/userprofile.php");exit;
	}	
}
