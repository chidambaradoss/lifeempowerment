...
$editcrs=$db->singlerec("select img1,img2,video_pre1,video_pre2,video1,video2 from course where id='$id'");
if(isset($complete)){
                ...
                <div class="tab-content">
                    <div class="tab-pane active" role="tabpanel" id="step1">
                        <div class="row">
						    <fieldset>	
							   ...
							   <legend>Basic Details</legend>
								...
								<div class="form-group">
								   ...
								   <textarea rows="5" name="description" id="description"  class="form-control" maxlength="100"><?php echo $description=isset($description)?$description:'';?></textarea>
								</div>						   
							   ...
							   <div class="row">
									<div class="col-sm-6">
										<div class="form-group">
										   ...
										   <select class="form-control" name="cate"  id="catid" onchange="getSubcategory(this.value)">
									...
									<div class="col-sm-6">
										<div class="form-group">
										   ...
										   <select class="form-control" name="sub" id="subid" >
							...
							<!--onclick="basicstp1();"-->
								<li><button type="button"   class="button primary rounded apply-button next-step"onclick="regvalidation()">Save and continue</button></li>
							</ul>
						</div>
                    </div>
                        ...
                        <div class="row">
							   ...
							   <fieldset>
								 ...
								 <div class="form-group">
								   ...
								   <textarea rows="5" name="courses" id="courses" class="form-control"><?php echo $courses=isset($courses)?$courses:'';?></textarea>
								</div>	
								
								
								<div class="form-group">
								   <label class="profile-label">Brief Description</label>
								   <textarea rows="5" name="descrip" id="descrip"  class="form-control"><?php echo $descrip=isset($descrip)?$descrip:'';?></textarea>
								</div>	
								
								<div class="form-group">
								   <label class="profile-label">Requirments</label>
								   <textarea rows="5" name="require" id="require"  class="form-control"><?php echo $require=isset($require)?$require:'';?></textarea>
								</div>
                        ...
                        <div class="row">
							   ...
							   <fieldset>
									...
									<div class="form-group">
									   ...
									   <textarea rows="5" name="answer" id="answer" class="form-control"><?php echo $answer=isset($answer)?$answer:'';?></textarea>
									</div>
									...
									<div id="add_faq" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
									  <div class="panel-body">
										...
										<div class="form-group">
										   <label class="profile-label">Answer</label>
										   <textarea rows="5" name="ans1" id="ans1" class="form-control"><?php echo $ans1=isset($ans1)?$ans1:'';?></textarea>
										</div>
									  </div>
									</div>
                        ...
                        <div class="row">
							   ...
							   <fieldset>
									...
									<div class="form-group">
									   ...
									   <div class="row">
												...
												<div class="col-sm-4">
													<button class="file-upload button info rounded"><input type="file" name="images1" class="file-input"> Choose File</button>
												<?php if(!empty($id)){ 
												?>
													<div class="col-sm-6"> 
									...
									<div id="add_image" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
									  <div class="panel-body">
										...
										<div class="form-group">
										   ...
										   <div class="row">
											  <div class="col-sm-4">
												 <button class="file-upload button info rounded"><input type="file" name="images2"  class="file-input"> Choose File</button>
												 <?php if(!empty($id)){ ?>
													<div class="col-sm-6"> 
							   ...
							   <fieldset class="mt30">
									...
									<div class="form-group">
									   ...
									   <div class="row">
									      <div class="col-sm-4">
										     <button class="file-upload button info rounded"><input type="file" name="images3" id="images3" class="file-input"> Choose File</button>
											 <?php if(!empty($id)){ ?>
												<div class="col-sm-6"> 
									...
									<div class="form-group">
									   ...
									   <div class="row">
									      <div class="col-sm-4">
										     <button class="file-upload button info rounded"><input type="file" name="images5" id="images5"  accept="video/*" class="file-input"> Choose File</button>
										  </div>
									...
									<div id="add_video" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
									  <div class="panel-body">
									   ...
									   <div class="row">
									      <div class="col-sm-4">
										     <button class="file-upload button info rounded"><input type="file" name="images4" class="file-input"> Choose File</button>
											 <?php if(!empty($id)){ ?>
												<div class="col-sm-6">
										...
										<div class="form-group">
										   ...
										   <div class="row">
											  <div class="col-sm-4">
												 <button class="file-upload button info rounded"><input type="file" name="images6"  accept="video/*" class="file-input"> Choose File</button>
											  </div>
								...
								<a class="collapsed button success rounded" role="button" data-toggle="collapse" data-parent="#accordion" href="#add_video" aria-expanded="false" aria-controls="add_video">+ Add More Videos</a>
							   </fieldset>
...
function prevTab(elem) {
 ...
 <script type="text/javascript">
	...
	function regvalidation(){
		var valform=document.myform;
		var title = document.getElementById("title").value;
		var description = document.getElementById("description").value;
		var cattt = document.getElementById("catid").value;
		var subcatt = document.getElementById("subid").value;
		var type = document.getElementById("type").value;
		var level = document.getElementById("level").value;
		
		if(title==0){ document.getElementById("title").style.borderColor = "red"; valform.title.focus(); return false;}
		else if(title!=0){ document.getElementById("title").style.borderColor = "#CCC"; }
		
		if(description==0){ document.getElementById("description").style.borderColor = "red"; valform.description.focus(); return false;}
		else if(title!=0){ document.getElementById("description").style.borderColor = "#CCC"; }
		
		if(cattt==0){ document.getElementById("catid").style.borderColor = "red"; valform.cate.focus(); return false;}
		else if(title!=0){ document.getElementById("catid").style.borderColor = "#CCC"; }
		
		if(subcatt==0){ document.getElementById("subid").style.borderColor = "red"; valform.sub.focus(); return false;}
		else if(subcatt!=0){ document.getElementById("subid").style.borderColor = "#CCC"; }
		
		if(type==0){ document.getElementById("type").style.borderColor = "red"; valform.type.focus(); return false;}
		else if(type!=0){ document.getElementById("type").style.borderColor = "#CCC"; }
		
		if(level==0){ document.getElementById("level").style.borderColor = "red"; valform.level.focus(); return false;}
		else if(level!=0){ document.getElementById("level").style.borderColor = "#CCC"; }
